...
import { Card, CardActions, CardContent, CardHeader, Divider, IconButton, Typography } from '@material-ui/core';
...
function getTextPreview(text: string) {
  ...
  console.log(preview)
  return (
    _.includes([',', '.', '!'], preview.slice(-1))
      ? preview.slice(0, -1)
      : preview
    ) + '...'
}

const PoemPreview: React.FunctionComponent<{ poem: Poem }> = (props) => {
